...
- <b>GPU SCheduling Optimization</b>
  ...
  - <b><i>(https://github.com/deepa-cv/GPU_Scheduling_Optimization)</b></i>

- <b>ADHD Task Manager</b>
  - This project infers the ADHD subtype of the person using Gemini-2.5Pro and displays an adaptive UI accordingly. Built using React.js and Gemini API. Deployed on Vercel
  - <b><i>(https://github.com/apurvab15/adhd-task-manager)</b></i>

- <b>Reward Hacking detection in Language Models</b>
  - This project aims to separate reward hacked responses from normal responses during inference. Trained on a custom dataset generated by altering the reward model using GRPO and the Big-Math dataset.
  - <b><i>(https://github.com/josephzhong/cs762_project)</b></i>
...
- Sotware Engineer Intern - Amazon Web Services, Seattle, WA, USA (May 2025-Aug 2025) <br>
